...
public class DeviceIpv4Addr  implements AnyOfDeviceIpv4Addr {
  ...
  public DeviceIpv4Addr publicAddress(String publicAddress) { 
  ...
  @Schema(example = "203.0.113.0", description = "A single IPv4 address with no subnet mask")
  ...
  public DeviceIpv4Addr privateAddress(String privateAddress) { 
  ...
  public DeviceIpv4Addr publicPort(Integer publicPort) { 
...
@Min(0) @Max(65535)   public Integer getPublicPort() {  
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeviceIpv4Addr deviceIpv4Addr = (DeviceIpv4Addr) o;
    return Objects.equals(this.publicAddress, deviceIpv4Addr.publicAddress) &&
        Objects.equals(this.privateAddress, deviceIpv4Addr.privateAddress) &&
        Objects.equals(this.publicPort, deviceIpv4Addr.publicPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceIpv4Addr {\n");
